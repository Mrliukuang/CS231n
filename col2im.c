...
void mexFunction(int nlhs, mxArray *plhs[],
    ...
    float *A = (float *)mxGetData(M_IN);  // A point to cols of size [C*filter_h*filter_w, N*HH*WW]
    ...
    // out size = [H, W, C, N]
    M_OUT = mxCreateNumericArray(4, out_size, mxSINGLE_CLASS, mxREAL);
    B = (float *)mxGetData(M_OUT); 
